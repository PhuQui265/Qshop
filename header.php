...
<head>
    ...
    <link rel="icon" href="./public/frontend/images/logo_header.PNG" type="image/x-icon">
    ...
    <!-- botchat -->
    <script type="text/javascript" src="https://ahachat.com/customer-chats/customer_chat_0sEipZGuo36383b9615b633.js"></script>
    <style>
        th {
            font-weight: bold;
            text-align: center;
        ...
        body {
            background-image: url(./public/frontend/images/bgr_body.jpg);
            background-size: 100%;
        }

        .navbar-default,
        #header {
            background-image: url(./public/frontend/images/bgr.jpg)
        }
    </style>
</head>
...
<body>
    ...
    <div class="col-md-2">
        <a href="index.php">
            <img style="padding-left: 100px;" width="90%" height="100%" src="./public/frontend/images/logo_header.PNG" alt="logo 47SHOP">
        </a>
    </div>
                ...
                <div class="col-md-2" id="header-right">
                    <div class="pull-right">
                        ...
                        <div class="pull-right">
                            ...
                            <p style="color: #fff"> 0879292571</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-left box-menu">
                    ...
                    <ul>
                        ...
                        <div class="panel-body">
                            <p><span class="glyphicon glyphicon-map-marker"></span> 180 Cao Lỗ, phường 4, quận 8, TP.HCM</p>
                        </div>
                        <div class="panel-body">
                            <p><span class="glyphicon glyphicon-phone"></span> Phone: 0879292571</p>
                        </div>
                        <div class="panel-body">
                            <p><span class="glyphicon glyphicon-envelope"></span> Email: DH51901916@student.stu.edu.vn</p>
                        </div>
                        <div class="panel-body">
                            <p><span class="glyphicon glyphicon-link"></span> Facebook: <a href="https://www.facebook.com/47storee/" target="_blank">47SHOP</a></p>
                        </div>
