<?php 
    ...
    **/
    ...
    $nFrom = 'Nguyễn Đức Độ';
    $mFrom = 'nguyenducdo009@gmail.com';  //dia chi email cua ban 
    $mPass = 'nguyenducdo21052001';       //mat khau email cua ban
    $mail = new PHPMailer();
    $body = $content;
    $mail->IsSMTP(); 
    $mail->CharSet   = "utf-8";
    ...
    $mail->AddReplyTo('nguyenducdo009@gmail.com', 'Nguyễn Đức Độ');
    if(!$mail->Send()) {
        return 0;
    } else {
        return 1;
